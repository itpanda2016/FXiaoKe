<%@ Page Title="" Language="C#" MasterPageFile="~/SiteHeader.Master" AutoEventWireup="true" CodeBehind="ImportLeave.aspx.cs" Inherits="SalesReport.ImportLeave" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form action="Handlers/HandlerImport.ashx" enctype="multipart/form-data" method="post">
        <div class="form-inline">
            <label>日期：</label><br />
            <input type="text" name="fmDate" id="fmDate" value="" class="form-control" style="width:300px;"/>
        </div>
        <div>
            <label>公司：</label>
        ...
        <input type="hidden" name="mod" value="leave" />
